	...
	public class ModelAgent {
		...
		public string CreatePrefab(PMDConverter.ShaderType shader_type, bool use_rigidbody, PMXConverter.AnimationType animation_type, bool use_ik, float scale, bool is_pmx_base_import) 
        {
            try
            {
                ...
                {
                    EditorUtility.DisplayProgressBar("CreatePrefab", "Import Pmx...", 1.0f/3.0f);
                ...
                {
                    EditorUtility.DisplayProgressBar("CreatePrefab", "Import Pmd...", 1.0f / 3.0f);
                ...
                // プレファブ化
                EditorUtility.DisplayProgressBar("CreatePrefab", "CreatePrefab...", 2.0f / 3.0f);
